...
schedular = optim.lr_scheduler.ExponentialLR(optimizer, gamma=0.92)
...
loss_train = guess_loss(bigram, loader_train, eval_iters=200)
print(f'loss_train = {loss_train}')
loss_test = guess_loss(bigram, loader_test, eval_iters=200)
